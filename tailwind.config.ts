...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        texture: "url('/background.webp')",
        noise: "url('/bg-shape-benefits.webp')",
        form: "url('/footer-form-bkg.jpg')",
        contactUsModal: "url('/doodad.jpg')",
        bkgForm: "url('/bkg-form.jpg')",
        test: "url('/bg-stack.avif')",
        woodMinded: "url('/wood-minded.avif')",
        alcotrade: "url('/alcotrade.avif')",
        inside: "url('/inside.avif')",
        yourProject: "url('/your-project.avif')",
        woodImage: "url('/wood-site.avif')",
        alcotradeImage: "url('/alcotrade-site.avif')",
        insideImage: "url('/inside-site.avif')",
        siteImage: "url('/bg-solution-website.avif')",
        whoAreWe: "url('/who.jpg')",
        stack: "url('/bg-stack.avif')",
