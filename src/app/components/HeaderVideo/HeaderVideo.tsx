...
export default function HeaderVideo() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      svgRef1.current,
      { y: -50, opacity: 0 },
      { y: 0, opacity: 1, duration: 5, ease: 'power2.out', delay: 5 }
    );

    gsap.fromTo(
      svgRef2.current,
      { y: 50, opacity: 0 },
      { y: 0, opacity: 1, duration: 2, ease: 'power2.out', delay: 5.1 }
    );
  }, []);
      ...
      >
        ...
        <div className="flex flex-col justify-between items-center py-14 md:py-0 md:gap-16 relative z-10 lg:w-[746px] lg:mr-6 xl:gap-20 h-full">
          ...
          <div className="relative w-full z-50">
            ...
            <div
              ref={svgRef1}
              className="absolute top-0 -left-4 lg:-top-20 lg:-left-6 w-16 h-16 lg:w-28 lg:h-28"
              dangerouslySetInnerHTML={{ __html: svg1 }}
            ></div>

            <div
              ref={svgRef2}
              className="absolute -bottom-10 -right-4 lg:-bottom-16 lg:-right-4 w-16 h-16 lg:w-28 lg:h-28"
              dangerouslySetInnerHTML={{ __html: svg2 }}
            ></div>
          </div>

          {/* Кнопка */}
          <button onClick={handleClick} className={`${css.button} mt-16`}>
