...
const HeaderUi = () => {
  return (
    <div className="relative">
      ...
      <div
        className={
          'absolute bg-uiImage flex items-center justify-center bg-center bg-cover mix-blend-color-dodge w-full h-[340px] md:h-[520px] -top-[25rem] md:-top-[35rem] lg:h-[690px] xl:h-[1000px] lg:-top-[50rem] xl:-top-[68rem] min-[1440px]:-top-[64rem]  text-white'
        }
      >
