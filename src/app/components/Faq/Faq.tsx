...
const CommerceFaq: React.FC<CommerceFaqProps> = ({ faqCard, commerceFaq }) => {
    ...
    <div className="flex h-[780px] justify-between items-center px-36">
      <div className="w-[550px]">
        ...
        <ul className="flex flex-col gap-3">
          {commerceFaq.map(faq => (
            <li key={faq.id} className="text-white border-b border-white flex justify-between py-2">
              <FaqPart
                id={faq.id}
                title={faq.title}
      ...
      <div className="relative w-[420px] h-[560px] rounded-2xl bg-gradient-to-br from-[#5AB899]/30 to-[#163C2F]/30">
        <div className="absolute w-full h-full rounded-2xl drop-shadow-custom backdrop-blur-xl"></div>
